...
class TroubleshootingTab(Adw.PreferencesPage):
    def __init__(self, vars: Vars, pack: Pack) -> None:
        ...
        open_logs_btn = Gtk.Button(icon_name="folder-open-symbolic")
        open_logs_btn.set_valign(Gtk.Align.CENTER)
        open_logs_btn.set_tooltip_text("Open the logs folder in the file manager")
        ...
        open_moods_btn = Gtk.Button(icon_name="folder-open-symbolic")
        open_moods_btn.set_valign(Gtk.Align.CENTER)
        open_moods_btn.set_tooltip_text("Open the moods folder in the file manager")
        ...
        open_pack_btn = Gtk.Button(icon_name="folder-open-symbolic")
        open_pack_btn.set_valign(Gtk.Align.CENTER)
        open_pack_btn.set_tooltip_text("Open the pack folder in the file manager")
