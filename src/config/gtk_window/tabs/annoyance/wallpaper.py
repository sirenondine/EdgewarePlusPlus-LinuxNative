...
class WallpaperTab(Adw.PreferencesPage):
    def __init__(self, vars: Vars, pack: Pack) -> None:
        ...
        set_btn = Gtk.Button(icon_name="image-x-generic-symbolic")
        ...
        auto_btn = Gtk.Button(icon_name="document-import-symbolic")
        auto_btn.set_tooltip_text("Set your current desktop wallpaper as the panic wallpaper")
        ...
        add_btn.set_tooltip_text("Add a wallpaper to the rotation")
        add_btn.connect("clicked", self._on_add)
        rot_actions.append(add_btn)
        self._wall_remove_btn = Gtk.Button(icon_name="list-remove-symbolic")
        self._wall_remove_btn.set_tooltip_text("Remove selected wallpaper")
