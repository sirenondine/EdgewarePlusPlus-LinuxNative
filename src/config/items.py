...
CONFIG_ITEMS = {
    ...
    "censor_part_male_genitals": Item("censorPartMaleGenitals", PERCENTAGE, VAR, int),
    "censor_part_buttocks": Item("censorPartButtocks", PERCENTAGE, VAR, int),
    "censor_part_anus": Item("censorPartAnus", PERCENTAGE, VAR, int),
    "censor_part_belly": Item("censorPartBelly", PERCENTAGE, VAR, int),
    "censor_part_armpits": Item("censorPartArmpits", PERCENTAGE, VAR, int),
    "censor_part_feet": Item("censorPartFeet", PERCENTAGE, VAR, int),
    ...
    "censor_part_male_genitals_covered": Item("censorPartMaleGenitalsCovered", BOOLEAN, VAR, bool),
    "censor_part_buttocks_covered": Item("censorPartButtocksCovered", BOOLEAN, VAR, bool),
    "censor_part_anus_covered": Item("censorPartAnusCovered", BOOLEAN, VAR, bool),
    "censor_part_belly_covered": Item("censorPartBellyCovered", BOOLEAN, VAR, bool),
    "censor_part_armpits_covered": Item("censorPartArmpitsCovered", BOOLEAN, VAR, bool),
    ...
    "escalation": Item("escalation", BOOLEAN, VAR, bool),
...
RESTART_REQUIRED: set[str] = {
    ...
    "desktopIcons", "panicButton", "globalPanicButton", "panicDisabled",
    "pauseOnLock", "pauseOnScreenshare", "pauseOnBattery", "pauseApps",
}
